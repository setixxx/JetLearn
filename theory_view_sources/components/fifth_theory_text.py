            ...
            ft.Container(
                ft.Column(
                    [
                        ...
                        ft.Text(
                            json_data[4]["content"][0],
                            size=20
                        ),
                        ft.Text(
                            json_data[4]["content"][1],
                            size=20
                        ),
                        ft.Text(
                            json_data[4]["content"][2],
                            size=20
                        ),
                        ft.Text(
                            json_data[4]["content"][3],
                            size=20
                        ),
                        CodeTheory(json_data[4]["code_examples"][0], page),
                        ft.Text(
                            json_data[4]["content"][4],
                            size=20
                        ),
                        ft.Text(
                            json_data[4]["content"][5],
                            size=20
                        ),
                        ft.Text(
                            json_data[4]["content"][6],
                            size=20
                        ),
                        ft.Container(
                            ft.Row(
