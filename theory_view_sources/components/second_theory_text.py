...
class SecondTheoryText(ft.Container):
            ...
            ft.Container(
                ft.Column(
                    [
                        ...
                        ft.Text(
                            json_data[1]["content"][0],
                            size=20
                        ),
                        ft.Text(
                            json_data[1]["content"][1],
                            size=20
                        ),
                        ft.Text(
                            json_data[1]["content"][2],
                            size=20
                        ),
                        CodeTheory(json_data[1]["code_examples"][0], page),
                        ft.Text(
                            json_data[1]["content"][3],
                            size=20
                        ),
                        ft.Text(
                            json_data[1]["content"][4],
                            size=20
                        ),
                        ft.Text(
                            json_data[1]["content"][5],
                            size=20
                        ),
                        ft.Container(
                            ft.Row(
