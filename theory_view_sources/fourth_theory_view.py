...
class FourthTheoryText(ft.Container):
            ...
            ft.Container(
                ft.Column(
                    [
                        ...
                        ft.Text(
                            json_data[3]["content"][0],
                            size=20
                        ),
                        ft.Text(
                            json_data[3]["content"][1],
                            size=20
                        ),
                        ft.Text(
                            json_data[3]["content"][2],
                            size=20
                        ),
                        CodeTheory(json_data[3]["code_examples"][0], page),
                        ft.Text(
                            json_data[3]["content"][3],
                            size=20
                        ),
                        ft.Text(
                            json_data[3]["content"][4],
                            size=20
                        ),
                        CodeTheory(json_data[3]["code_examples"][1], page),
                        ft.Text(
                            json_data[3]["content"][5],
                            size=20
                        ),
                        ft.Text(
                            json_data[3]["content"][6],
                            size=20
                        ),
                        ft.Text(
                            json_data[3]["content"][7],
                            size=20
                        ),
                        ft.Container(
                            ft.Row(
