...
class SixthTheoryText(ft.Container):
            ...
            ft.Container(
                ft.Column(
                    [
                        ...
                        ft.Text(
                            json_data[5]["content"][0],
                            size=20
                        ),
                        ft.Text(
                            json_data[5]["content"][1],
                            size=20
                        ),
                        ft.Text(
                            json_data[5]["content"][2],
                            size=20
                        ),
                        CodeTheory(json_data[5]["code_examples"][0], page),
                        ft.Text(
                            json_data[5]["content"][3],
                            size=20
                        ),
                        ft.Text(
                            json_data[5]["content"][4],
                            size=20
                        ),
                        CodeTheory(json_data[5]["code_examples"][1], page),
                        ft.Text(
                            json_data[5]["content"][5],
                            size=20
                        ),
                        ft.Text(
                            json_data[5]["content"][6],
                            size=20
                        ),
                        ft.Text(
                            json_data[5]["content"][7],
                            size=20
                        ),
                        ft.Container(
                            ft.Row(
    ...
    def update_theory_state(self, login, theory):
        ...
        self.page.go("/main/theory_7")


class SixthTheoryView(ft.View):
