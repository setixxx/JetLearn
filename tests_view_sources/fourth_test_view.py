...
from tests_view_sources.components.fourth_test import FourthTest


class FourthTestView(ft.View):
                ...
                ft.Row(
                    [
                        ...
                        ft.Container(
                            ft.Column(
                                [
                                    FourthTest(self.page, questions, self.restart_test, self.db_manager, self.app_state)
                                ],
