...
from tests_view_sources.components.third_test import ThirdTest


class ThirdTestView(ft.View):
                ...
                ft.Row(
                    [
                        ...
                        ft.Container(
                            ft.Column(
                                [
                                    ThirdTest(self.page, questions, self.restart_test, self.db_manager, self.app_state)
                                ],
