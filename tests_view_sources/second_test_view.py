                ...
                ft.Column(
                    [
                        ...
                        *self.create_test_texts(),
                        Results(self.page, self.test_texts, self.restart_test, self.db_manager, self.app_state, "TESTS_2"),
                    ]
                ),
                ...
                ft.Row(
                    [
                        ...
                        ft.Container(
                            ft.Column(
                                [
                                    SecondTest(self.page, questions, self.restart_test, self.db_manager, self.app_state)
                                ],
