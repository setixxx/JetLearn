...
from tests_view_sources.components.fifth_test import FifthTest


class FifthTestView(ft.View):
                ...
                ft.Row(
                    [
                        ...
                        ft.Container(
                            ft.Column(
                                [
                                    FifthTest(self.page, questions, self.restart_test, self.db_manager, self.app_state)
                                ],
