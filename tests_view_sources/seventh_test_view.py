...
from tests_view_sources.components.seventh_test import  SeventhTest


class SeventhTestView(ft.View):
                ...
                ft.Row(
                    [
                        ...
                        ft.Container(
                            ft.Column(
                                [
                                    SeventhTest(self.page, questions, self.restart_test, self.db_manager, self.app_state)
                                ],
